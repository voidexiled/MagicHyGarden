...
public class FarmAdminEconomySetSubCommand extends AbstractTargetPlayerCommand {
    private final RequiredArg<Integer> amountArg;


    public FarmAdminEconomySetSubCommand() {
        super("set", "magichygarden.command.farm.admin.economy.set.description");

        amountArg = withRequiredArg(
                "amount",
                "magichygarden.command.farm.admin.economy.set.args.amount.description",
                ArgTypes.INTEGER
    ...
    protected void execute(@NonNull CommandContext commandContext,
        ...
        MghgEconomyManager.setBalance(playerRef.getUuid(), amount);

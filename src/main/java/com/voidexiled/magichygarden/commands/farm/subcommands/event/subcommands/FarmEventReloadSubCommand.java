...
public class FarmEventReloadSubCommand extends AbstractPlayerCommand {
    public FarmEventReloadSubCommand() {
        super("reload", "magichygarden.command.farm.event.reload.description");
    }

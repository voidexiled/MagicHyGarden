package com.voidexiled.magichygarden.commands.farm.subcommands.visit;
...
public class FarmVisitSubCommand extends AbstractPlayerCommand {
    private final DefaultArg<String> ownerArg;

    public FarmVisitSubCommand() {

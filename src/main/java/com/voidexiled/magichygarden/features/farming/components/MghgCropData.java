...
public class MghgCropData implements Component<ChunkStore> {
    ...
    public static final BuilderCodec<MghgCropData> CODEC = BuilderCodec.builder(MghgCropData.class, MghgCropData::new)
            ...
            .append(
                    new KeyedCodec<>("PlantTime", Codec.INSTANT),
                    (c, v) -> c.plantTime = v,
                    c -> c.plantTime
            ).add()
            .append(
    ...
    @Nullable
    public Instant getPlantTime() { return plantTime; }
    public void setPlantTime(@Nullable Instant plantTime) { this.plantTime = plantTime; }
